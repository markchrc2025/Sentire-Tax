// Form2316.tsx — faithful 2316 replica (Certificate of Compensation Payment / Tax Withheld).
// Ported from form-2316.jsx.
...
export function Form2316({ tp, data, set, comp }: FormProps<Comp2316>) {
  ...
  const NTrow = (no: string, label: ReactNode, field: string) => (
  ...
  const summaryRows: Array<[string, string, number]> = [
    ...
    ["21", "Taxable Compensation (Present)", comp.i21],
  ];
    ...
    <div className="bir-sheet">
      ...
      <div className="row b" style={{ borderTop: 0 }}>
        <div className="bir-cell inline br grow">
          <span className="lblgrp">
            <span className="bir-ino">4</span> <span className="bir-cap">Employee&rsquo;s Name</span>
          </span>
          <div className="fld">
            <BirVal value={name} />
          </div>
      ...
      <div className="row b" style={{ borderTop: 0 }}>
        ...
        <div className="bir-cell inline" style={{ width: 150 }}>
          <span className="lblgrp">
            <span className="bir-ino">6A</span> <span className="bir-cap">ZIP</span>
          </span>
          <div className="fld">
      ...
      <div className="row b" style={{ borderTop: 0 }}>
        <div className="bir-cell inline br" style={{ width: 320 }}>
          <span className="lblgrp">
            <span className="bir-ino">7</span> <span className="bir-cap">Date of Birth</span>
          </span>
          <div className="fld">
            <BirVal value={dob} />
          </div>
      ...
      <div className="row b" style={{ borderTop: 0 }}>
        ...
        <div className="bir-cell inline" style={{ width: 150 }}>
          <span className="lblgrp">
            <span className="bir-ino">14A</span> <span className="bir-cap">ZIP</span>
          </span>
          <div className="fld">
      ...
      <div className="row" style={{ alignItems: "stretch" }}>
        ...
        <div className="col br b grow" style={{ borderTop: 0, borderRight: 0 }}>
          <div className="bir-section bb">
            Part IV-B – Details of Compensation Income &amp; Tax Withheld
          </div>
          <div className="bir-line" style={{ background: "var(--shade)", fontWeight: 700 }}>
            <div className="num"></div>
            <div className="desc">A. Non-Taxable / Exempt Compensation</div>
          ...
          <div className="bir-line bt" style={{ background: "var(--shade2)", fontWeight: 700 }}>
            ...
            <div className="desc">Total Non-Taxable/Exempt (Sum 29 to 37)</div>
            <div className="amtcell bl br" style={{ width: 200 }}>
          ...
          <div className="bir-line bt" style={{ background: "var(--shade2)", fontWeight: 700 }}>
            ...
            <div className="desc">Total Taxable Compensation Income</div>
            <div className="amtcell bl br" style={{ width: 200 }}>
        ...
        <div className="col b" style={{ borderTop: 0, width: 330, flex: "none" }}>
          ...
          <div className="bir-line bt">
            ...
            <div className="desc" style={{ fontSize: 9.6 }}>
              Add: Taxable Comp. from Previous Employer
            </div>
            <div className="amtcell bl" style={{ width: 130 }}>
          ...
          <div className="bir-line bt">
            ...
            <div className="desc" style={{ fontSize: 9.6 }}>
              Taxes Withheld – Present Employer
            </div>
            <div className="amtcell bl" style={{ width: 130 }}>
          ...
          <div className="bir-line bt">
            ...
            <div className="desc" style={{ fontSize: 9.6 }}>
              Taxes Withheld – Previous Employer
            </div>
            <div className="amtcell bl" style={{ width: 130 }}>
